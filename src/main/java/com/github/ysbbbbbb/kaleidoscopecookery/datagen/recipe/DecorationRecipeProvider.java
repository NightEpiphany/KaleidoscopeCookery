...
public class DecorationRecipeProvider extends ModRecipeProvider {
    public DecorationRecipeProvider(@NonNull BootstrapContext<Recipe<?>> recipes, @NonNull BootstrapContext<Advancement> advancements) {
    ...
    private ShapedRecipeBuilder addCookStool(Item result, Block wood) {
        return this.shaped(RecipeCategory.DECORATIONS, result)
                .pattern("   ")
                .pattern("###")
                .pattern("# #")
                .define('#', wood)
