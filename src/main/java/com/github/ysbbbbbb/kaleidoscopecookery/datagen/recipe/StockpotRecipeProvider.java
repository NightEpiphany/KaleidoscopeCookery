...
public class StockpotRecipeProvider extends ModRecipeProvider {
    public StockpotRecipeProvider(@NonNull BootstrapContext<Recipe<?>> recipes, @NonNull BootstrapContext<Advancement> advancements) {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setResult(ModItems.PORK_BONE_SOUP, 1)
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setResult(ModItems.FEARSOME_THICK_SOUP, 1)
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setResult(ModItems.LAMB_AND_RADISH_SOUP, 1)
                .save(consumer, "lamb_and_radish_soup");

        StockpotRecipeBuilder.builder()
                .addInput(Items.POTATO, Items.POTATO, Items.POTATO, TagCommon.RAW_BEEF, TagCommon.RAW_BEEF)
                .setResult(ModItems.BRAISED_BEEF_WITH_POTATOES, 1)
                .save(consumer, "braised_beef_with_potatoes");

        StockpotRecipeBuilder.builder()
                .addInput(CommonTags.Items.MUSHROOMS, CommonTags.Items.MUSHROOMS, CommonTags.Items.MUSHROOMS, Items.RABBIT, Items.RABBIT)
                .setResult(ModItems.WILD_MUSHROOM_RABBIT_SOUP, 1)
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setResult(ModItems.BORSCHT, 1)
                .save(consumer, "borscht");

        StockpotRecipeBuilder.builder()
                .addInput(ModItems.RAW_MEATBALL, ModItems.RAW_MEATBALL,
                        TagCommon.CROPS_LETTUCE, TagCommon.CROPS_LETTUCE, TagCommon.CROPS_LETTUCE)
                .setResult(ModItems.BEEF_MEATBALL_SOUP, 1)
                .save(consumer, "beef_meatball_soup");

        StockpotRecipeBuilder.builder()
                .addInput(TagCommon.RAW_CHICKEN, TagCommon.RAW_CHICKEN,
                        CommonTags.Items.MUSHROOMS, CommonTags.Items.MUSHROOMS, CommonTags.Items.MUSHROOMS)
                .setResult(ModItems.CHICKEN_AND_MUSHROOM_STEW, 1)
                .save(consumer, "chicken_and_mushroom_stew");

        StockpotRecipeBuilder.builder()
                .addInput(CommonTags.Items.SEEDS, CommonTags.Items.SEEDS, CommonTags.Items.SEEDS,
                        CommonTags.Items.SEEDS, CommonTags.Items.SEEDS, CommonTags.Items.SEEDS,
                        Items.SUGAR, Items.SUGAR, Items.SUGAR)
                .setResult(ModItems.LABA_CONGEE, 1)
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setResult(ModItems.BEEF_NOODLE, 1)
        ...
        StockpotRecipeBuilder.builder()
                ...
                .setSoupBase(ModSoupBases.LAVA)
                .setResult(ModItems.HOT_DRY_NOODLES, 1)
        ...
        FlexStockpotRecipeBuilder.builder()
                .addInput(Items.RABBIT, CommonTags.Items.MUSHROOMS)
                .setResult(ModItems.WILD_MUSHROOM_RABBIT_SOUP, 1)
                .save(consumer, "wild_mushroom_rabbit_soup");
        ...
        FlexStockpotRecipeBuilder.builder()
                .addInput(TagCommon.RAW_CHICKEN, CommonTags.Items.MUSHROOMS)
                .setResult(ModItems.CHICKEN_AND_MUSHROOM_STEW, 1)
                .save(consumer, "chicken_and_mushroom_stew");

        FlexStockpotRecipeBuilder.builder()
                .addInput(CommonTags.Items.SEEDS, Items.SUGAR)
                .setResult(ModItems.LABA_CONGEE, 1)
                .save(consumer, "laba_congee");
    ...
    private void addDumplingRecipes(RecipeOutput consumer) {
        for (int count = 1; count <= 9; count++) {
            StockpotRecipeBuilder.builder()
                    .addInput((Object[]) this.getItemsWithCount(STUFFED_DOUGH_FOOD, count))
    ...
    private void addShengjianMantouRecipes(RecipeOutput consumer) {
        for (int count = 1; count <= 9; count++) {
            StockpotRecipeBuilder.builder()
                    .addInput((Object[]) this.getItemsWithCount(STUFFED_DOUGH_FOOD, count))
                    .setResult(ModItems.SHENGJIAN_MANTOU, count)
                    .setSoupBase(ModSoupBases.LAVA)
                    .setEmptyCarrier()
    ...
    private void addZongziRecipes(RecipeOutput consumer) {
        for (int count = 1; count <= 9; count++) {
            StockpotRecipeBuilder.builder()
                    .addInput((Object[]) this.getItemsWithCount(ModItems.RAW_ZONGZI, count))
