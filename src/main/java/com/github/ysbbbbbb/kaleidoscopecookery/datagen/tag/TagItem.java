...
public class TagItem extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(VILLAGER_PLANTABLE_SEEDS).add(ModItems.TOMATO_SEED, ModItems.CHILI_SEED,
        ...
        tag(TagCommon.DOUGH).add(ModItems.RAW_DOUGH);

        // 均衡饮食兼容
        tag(TagCommon.GRAINS).add(ModItems.RICE_SEED, ModItems.RICE_PANICLE);
        tag(TagCommon.PROTEINS).add(ModItems.CATERPILLAR);
    ...
    private void addPotIngredient() {
        tag(POT_INGREDIENT)
                ...
                .addTag(TagCommon.VEGETABLES_TOMATO)
                .addTag(TagCommon.VEGETABLES_LETTUCE)
                .addTag(TagCommon.SEEDS_CHILI_PEPPER)
                .addTag(TagCommon.SEEDS_TOMATO)
                .addTag(TagCommon.SEEDS_LETTUCE)
                .addTag(TagCommon.SEEDS_RICE)
                .addTag(TagCommon.EGGS)
                .add(
                        ModItems.RAW_DOUGH,
                        ModItems.RAW_NOODLES,
                        ModItems.STUFFED_DOUGH_FOOD
                ).add(
                        STONE,
                        GRANITE,
                        POLISHED_GRANITE,
