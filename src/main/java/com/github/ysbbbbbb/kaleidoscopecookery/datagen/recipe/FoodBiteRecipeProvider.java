    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        PotRecipeBuilder.builder()
                .addInput(ModItems.GREEN_CHILI, ModItems.GREEN_CHILI,
                        ModItems.GREEN_CHILI, ModItems.GREEN_CHILI,
        ...
        PotRecipeBuilder.builder()
                .addInput(Items.PHANTOM_MEMBRANE, Items.PHANTOM_MEMBRANE,
                        ...
                        CommonTags.Items.MUSHROOMS, CommonTags.Items.MUSHROOMS)
                .setBowlCarrier()
        ...
        FlexPotRecipeBuilder.builder()
                .addInput(ModItems.GREEN_CHILI, ModItems.RAW_CUT_SMALL_MEATS)
                .setBowlCarrier()
                .setResult(FoodBiteRegistry.STUFFED_TIGER_SKIN_PEPPER)
                .save(consumer);
        ...
        FlexPotRecipeBuilder.builder()
                .addInput(Items.PHANTOM_MEMBRANE, TagCommon.RAW_PORK, CommonTags.Items.MUSHROOMS)
                .setBowlCarrier()
                .setResult(FoodBiteRegistry.FRIED_SPRING_ROLL)
                .save(consumer);
