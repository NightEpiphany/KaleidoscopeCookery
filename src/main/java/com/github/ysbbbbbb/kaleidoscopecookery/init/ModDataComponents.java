...
public class ModDataComponents {
    ...
    public static final DataComponentType<Boolean> KITCHEN_SHOVEL_HAS_OIL = Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE,
            Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "kitchen_shovel_has_oil"),
    ...
    public static final DataComponentType<TransmutationLunchBagItem.ItemContainer> TRANSMUTATION_LUNCH_BAG_ITEMS =
            Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE,
            Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "transmutation_lunch_bag_items"),
    ...
    public static final DataComponentType<RecipeItem.RecipeRecord> RECIPE_RECORD = Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE,
            Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "recipe_record"),
    ...
    public static final DataComponentType<Integer> OIL_POT_OIL_COUNT = Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE,
            Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "oil_pot_oil_count"),
    ...
    public static final DataComponentType<String> MODEL_DISPLAY_MODEL = Registry.register(
            BuiltInRegistries.DATA_COMPONENT_TYPE,
            Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "model_data"),
