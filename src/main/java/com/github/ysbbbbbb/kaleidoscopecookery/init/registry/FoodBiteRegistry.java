...
public final class FoodBiteRegistry {
    ...
    public static void init() {
        ...
        BLAZE_LAMB_CHOP = INSTANCE.registerFoodData("blaze_lamb_chop", FoodData
                .create(3, BLAZE_LAMB_CHOP_BLOCK, BLAZE_LAMB_CHOP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.BLAZE_ROD));

        FROST_LAMB_CHOP = INSTANCE.registerFoodData("frost_lamb_chop", FoodData
                .create(3, FROST_LAMB_CHOP_BLOCK, FROST_LAMB_CHOP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.BLUE_ICE));

        NETHER_STYLE_SASHIMI = INSTANCE.registerFoodData("nether_style_sashimi", FoodData
                .create(4, NETHER_STYLE_SASHIMI_BLOCK, NETHER_STYLE_SASHIMI_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
        ...
        END_STYLE_SASHIMI = INSTANCE.registerFoodData("end_style_sashimi", FoodData
                .create(4, END_STYLE_SASHIMI_BLOCK, END_STYLE_SASHIMI_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.CHORUS_FRUIT));

        DESERT_STYLE_SASHIMI = INSTANCE.registerFoodData("desert_style_sashimi", FoodData
                .create(4, DESERT_STYLE_SASHIMI_BLOCK, DESERT_STYLE_SASHIMI_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.CACTUS));

        TUNDRA_STYLE_SASHIMI = INSTANCE.registerFoodData("tundra_style_sashimi", FoodData
                .create(4, TUNDRA_STYLE_SASHIMI_BLOCK, TUNDRA_STYLE_SASHIMI_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        COLD_STYLE_SASHIMI = INSTANCE.registerFoodData("cold_style_sashimi", FoodData
                .create(4, COLD_STYLE_SASHIMI_BLOCK, COLD_STYLE_SASHIMI_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.SNOWBALL, Items.SNOWBALL));

        CANDIED_POTATO = INSTANCE.registerFoodData("candied_potato", FoodData
                .create(3, CANDIED_POTATO_BLOCK, CANDIED_POTATO_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        STUFFED_TIGER_SKIN_PEPPER = INSTANCE.registerFoodData("stuffed_tiger_skin_pepper", FoodData
                .create(5, STUFFED_TIGER_SKIN_PEPPER_BLOCK, STUFFED_TIGER_SKIN_PEPPER_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        SPICY_RABBIT_HEAD = INSTANCE.registerFoodData("spicy_rabbit_head", FoodData
                .create(3, SPICY_RABBIT_HEAD_BLOCK, SPICY_RABBIT_HEAD_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        FRIED_CATERPILLAR = INSTANCE.registerFoodData("fried_caterpillar", FoodData
                .create(3, FRIED_CATERPILLAR_BLOCK, FRIED_CATERPILLAR_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .setAABB(Block.box(1, 0, 3, 15, 4, 13)));

        FRIED_SPRING_ROLL = INSTANCE.registerFoodData("fried_spring_roll", FoodData
                .create(3, FRIED_SPRING_ROLL_BLOCK, FRIED_SPRING_ROLL_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        FRUIT_PLATTER = INSTANCE.registerFoodData("fruit_platter", FoodData
                .create(4, FRUIT_PLATTER_BLOCK, FRUIT_PLATTER_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        // ========================== 1x2 食物 ==========================

        BRAISED_PORK_RIBS = INSTANCE.registerFoodData("braised_pork_ribs", FoodData
                .createOneByTwo(4, BRAISED_PORK_RIBS_BLOCK, BRAISED_PORK_RIBS_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.BONE));

        COLD_ROASTED_MEAT = INSTANCE.registerFoodData("cold_roasted_meat", FoodData
                .createOneByTwo(3, COLD_ROASTED_MEAT_BLOCK, COLD_ROASTED_MEAT_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM));

        OIL_SPLASHED_FISH = INSTANCE.registerFoodData("oil_splashed_fish", FoodData
                .createOneByTwo(5, OIL_SPLASHED_FISH_BLOCK, OIL_SPLASHED_FISH_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .addLootItems(Items.BONE_MEAL));

        // ========================== 汤食类 ==========================

        DOUGH_DROP_SOUP = INSTANCE.registerFoodData("dough_drop_soup", FoodData
                .create(3, DOUGH_DROP_SOUP_BLOCK, DOUGH_DROP_SOUP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .bowlAABB());

        FOUR_JOY_MEATBALL_SOUP = INSTANCE.registerFoodData("four_joy_meatball_soup", FoodData
                .create(4, FOUR_JOY_MEATBALL_SOUP_BLOCK, FOUR_JOY_MEATBALL_SOUP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .bowlAABB());

        NUMBING_SPICY_CHICKEN = INSTANCE.registerFoodData("numbing_spicy_chicken", FoodData
                .create(3, NUMBING_SPICY_CHICKEN_BLOCK, NUMBING_SPICY_CHICKEN_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .bowlAABB());

        SPICY_BLOOD_STEW = INSTANCE.registerFoodData("spicy_blood_stew", FoodData
                .create(3, SPICY_BLOOD_STEW_BLOCK, SPICY_BLOOD_STEW_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .bowlAABB());

        // ========================== 瓦罐汤 ==========================

        BROWN_MUSHROOM_POT_SOUP = INSTANCE.registerFoodData("brown_mushroom_pot_soup", FoodData
                .create(2, BROWN_MUSHROOM_POT_SOUP_BLOCK, BROWN_MUSHROOM_POT_SOUP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .setLootItem(Items.FLOWER_POT)
                .soupPotAABB()
                .potSoupAnimateTick());

        RED_MUSHROOM_POT_SOUP = INSTANCE.registerFoodData("red_mushroom_pot_soup", FoodData
                .create(2, RED_MUSHROOM_POT_SOUP_BLOCK, RED_MUSHROOM_POT_SOUP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .setLootItem(Items.FLOWER_POT)
                .soupPotAABB()
                .potSoupAnimateTick());

        WARPED_FUNGUS_POT_SOUP = INSTANCE.registerFoodData("warped_fungus_pot_soup", FoodData
                .create(2, WARPED_FUNGUS_POT_SOUP_BLOCK, WARPED_FUNGUS_POT_SOUP_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .setLootItem(Items.FLOWER_POT)
                .soupPotAABB()
                .potSoupAnimateTick());

        CRIMSON_FUNGUS_POT_SOUP = INSTANCE.registerFoodData("crimson_fungus_pot_soup", FoodData
                .create(2, CRIMSON_FUNGUS_POT_SOUP_BLOCK, CRIMSON_FUNGUS_POT_SOUP_ITEM, ModConsumables.BLAZE_LAMB_CHOP_BLOCK, ModConsumables.BLAZE_LAMB_CHOP_ITEM)
                .setLootItem(Items.FLOWER_POT)
                .soupPotAABB()
                .potSoupAnimateTick());

        BUDDHA_JUMPS_OVER_THE_WALL = INSTANCE.registerFoodData("buddha_jumps_over_the_wall", FoodData
                .create(2, BUDDHA_JUMPS_OVER_THE_WALL_BLOCK, BUDDHA_JUMPS_OVER_THE_WALL_ITEM, ModConsumables.CRYSTAL_LAMB_CHOP_BLOCK, ModConsumables.CRYSTAL_LAMB_CHOP_ITEM)
                .setLootItem(Items.FLOWER_POT)
                .soupPotAABB()
                .potSoupAnimateTick());
        ...
        GOLDEN_SALAD = INSTANCE.registerFoodData("golden_salad", FoodData
                .create(6, GOLDEN_SALAD_BLOCK, GOLDEN_SALAD_ITEM, ModConsumables.BLAZE_LAMB_CHOP_BLOCK, ModConsumables.BLAZE_LAMB_CHOP_ITEM));
    }
