...
public final class CommonRegistry {
    ...
    public static void registerDataListeners() {
        ResourceLoader.get(PackType.SERVER_DATA).registerReloader(Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "millstone_bindable_data"), new MillstoneBindableDataReloadListener());
    }
