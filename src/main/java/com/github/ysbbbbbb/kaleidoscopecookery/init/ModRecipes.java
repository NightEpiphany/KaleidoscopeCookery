...
public final class ModRecipes {
    ...
    public static final RecipeType<FlexStockpotRecipe> FLEX_STOCKPOT_RECIPE = simple(ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "flex_stockpot"));
    ...
    public static void registerRecipes() {
        ...
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "flex_stockpot"), FLEX_STOCKPOT_SERIALIZER);
        ...
        Registry.register(BuiltInRegistries.RECIPE_TYPE, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "flex_stockpot"), FLEX_STOCKPOT_RECIPE);
