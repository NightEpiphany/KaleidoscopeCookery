...
public final class ModItems {
    ...
    // Tools
    public static final Item IRON_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterial.IRON, 3.0F, -2.4F);
    public static final Item GOLD_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterial.GOLD, 3.0F, -2.4F);
    public static final Item DIAMOND_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterial.DIAMOND, 3.0F, -2.4F);
    public static final Item NETHERITE_KITCHEN_KNIFE = new KitchenKnifeItem(ToolMaterial.NETHERITE, 3.0F, -2.4F);
    ...
    public static final Item FARMER_CHEST_PLATE = new Item(new Item.Properties().stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER, ArmorType.CHESTPLATE));
    public static final Item FARMER_LEGGINGS = new Item(new Item.Properties().stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER, ArmorType.LEGGINGS));
    public static final Item FARMER_BOOTS = new Item(new Item.Properties().stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER, ArmorType.BOOTS));
    public static final Item TRANSMUTATION_LUNCH_BAG = new TransmutationLunchBagItem();

    // Seeds
    public static final Item TOMATO_SEED = new BlockItem(ModBlocks.TOMATO_CROP, new Item.Properties());
    public static final Item CHILI_SEED = new BlockItem(ModBlocks.CHILI_CROP, new Item.Properties());
    public static final Item LETTUCE_SEED = new BlockItem(ModBlocks.LETTUCE_CROP, new Item.Properties());
    public static final Item RICE_SEED = new RiceItem();
    public static final Item WILD_RICE_SEED = new BlockItem(ModBlocks.RICE_CROP, new Item.Properties());
    ...
    public static final Item DONKEY_BURGER = new FoodWithEffectsItem(ModFoods.DONKEY_BURGER, ModConsumables.DONKEY_BURGER);
    public static final Item MANTOU = new FoodWithEffectsItem(ModFoods.MANTOU, ModConsumables.MANTOU);
    public static final Item BAOZI = new FoodWithEffectsItem(ModFoods.BAOZI, ModConsumables.BAOZI);
    public static final Item SAMSA = new FoodWithEffectsItem(ModFoods.SAMSA, ModConsumables.SAMSA);
    public static final Item MEAT_PIE = new FoodWithEffectsItem(ModFoods.MEAT_PIE, ModConsumables.MEAT_PIE);
    public static final Item DUMPLING = new BowlFoodOnlyItem(ModFoods.DUMPLING, ModConsumables.DUMPLING);
    ...
    // Bowl foods
    public static final Item COOKED_RICE = new BowlFoodOnlyItem(ModFoods.COOKED_RICE, ModConsumables.COOKED_RICE);
    public static final Item SCRAMBLE_EGG_WITH_TOMATOES = new BowlFoodOnlyItem(ModFoods.SCRAMBLE_EGG_WITH_TOMATOES, ModConsumables.SCRAMBLE_EGG_WITH_TOMATOES);
    public static final Item SCRAMBLE_EGG_WITH_TOMATOES_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.SCRAMBLE_EGG_WITH_TOMATOES_RICE_BOWL, ModConsumables.SCRAMBLE_EGG_WITH_TOMATOES_RICE_BOWL);
    public static final Item STIR_FRIED_BEEF_OFFAL = new BowlFoodOnlyItem(ModFoods.STIR_FRIED_BEEF_OFFAL, ModConsumables.STIR_FRIED_BEEF_OFFAL);
    public static final Item STIR_FRIED_BEEF_OFFAL_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.STIR_FRIED_BEEF_OFFAL_RICE_BOWL, ModConsumables.STIR_FRIED_BEEF_OFFAL_RICE_BOWL);
    public static final Item BRAISED_BEEF = new BowlFoodOnlyItem(ModFoods.BRAISED_BEEF, ModConsumables.BRAISED_BEEF);
    public static final Item BRAISED_BEEF_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.BRAISED_BEEF_RICE_BOWL, ModConsumables.BRAISED_BEEF_RICE_BOWL);
    public static final Item STIR_FRIED_PORK_WITH_PEPPERS = new BowlFoodOnlyItem(ModFoods.STIR_FRIED_PORK_WITH_PEPPERS, ModConsumables.STIR_FRIED_PORK_WITH_PEPPERS);
    public static final Item STIR_FRIED_PORK_WITH_PEPPERS_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.STIR_FRIED_PORK_WITH_PEPPERS_RICE_BOWL, ModConsumables.STIR_FRIED_PORK_WITH_PEPPERS_RICE_BOWL);
    public static final Item SWEET_AND_SOUR_PORK = new BowlFoodOnlyItem(ModFoods.SWEET_AND_SOUR_PORK, ModConsumables.SWEET_AND_SOUR_PORK);
    public static final Item SWEET_AND_SOUR_PORK_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.SWEET_AND_SOUR_PORK_RICE_BOWL, ModConsumables.SWEET_AND_SOUR_PORK_RICE_BOWL);
    public static final Item COUNTRY_STYLE_MIXED_VEGETABLES = new BowlFoodOnlyItem(ModFoods.COUNTRY_STYLE_MIXED_VEGETABLES, ModConsumables.COUNTRY_STYLE_MIXED_VEGETABLES);
    public static final Item FISH_FLAVORED_SHREDDED_PORK = new BowlFoodOnlyItem(ModFoods.FISH_FLAVORED_SHREDDED_PORK, ModConsumables.FISH_FLAVORED_SHREDDED_PORK);
    public static final Item FISH_FLAVORED_SHREDDED_PORK_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.FISH_FLAVORED_SHREDDED_PORK_RICE_BOWL, ModConsumables.FISH_FLAVORED_SHREDDED_PORK_RICE_BOWL);
    public static final Item BRAISED_FISH_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.BRAISED_FISH_RICE_BOWL, ModConsumables.BRAISED_FISH_RICE_BOWL);
    public static final Item SPICY_CHICKEN_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.SPICY_CHICKEN_RICE_BOWL, ModConsumables.SPICY_CHICKEN_RICE_BOWL);
    public static final Item SUSPICIOUS_STIR_FRY_RICE_BOWL = new BowlFoodOnlyItem(ModFoods.SUSPICIOUS_STIR_FRY_RICE_BOWL, ModConsumables.SUSPICIOUS_STIR_FRY_RICE_BOWL);
    public static final Item EGG_FRIED_RICE = new BowlFoodOnlyItem(ModFoods.EGG_FRIED_RICE, ModConsumables.EGG_FRIED_RICE);
    public static final Item DELICIOUS_EGG_FRIED_RICE = new BowlFoodOnlyItem(ModFoods.DELICIOUS_EGG_FRIED_RICE, ModConsumables.DELICIOUS_EGG_FRIED_RICE);
    public static final Item PORK_BONE_SOUP = new BowlFoodOnlyItem(ModFoods.PORK_BONE_SOUP, ModConsumables.PORK_BONE_SOUP);
    public static final Item SEAFOOD_MISO_SOUP = new BowlFoodOnlyItem(ModFoods.SEAFOOD_MISO_SOUP, ModConsumables.SEAFOOD_MISO_SOUP);
    public static final Item FEARSOME_THICK_SOUP = new BowlFoodOnlyItem(ModFoods.FEARSOME_THICK_SOUP, ModConsumables.FEARSOME_THICK_SOUP);
    public static final Item LAMB_AND_RADISH_SOUP = new BowlFoodOnlyItem(ModFoods.LAMB_AND_RADISH_SOUP, ModConsumables.LAMB_AND_RADISH_SOUP);
    public static final Item BRAISED_BEEF_WITH_POTATOES = new BowlFoodOnlyItem(ModFoods.BRAISED_BEEF_WITH_POTATOES, ModConsumables.BRAISED_BEEF_WITH_POTATOES);
    public static final Item WILD_MUSHROOM_RABBIT_SOUP = new BowlFoodOnlyItem(ModFoods.WILD_MUSHROOM_RABBIT_SOUP, ModConsumables.WILD_MUSHROOM_RABBIT_SOUP);
    public static final Item TOMATO_BEEF_BRISKET_SOUP = new BowlFoodOnlyItem(ModFoods.TOMATO_BEEF_BRISKET_SOUP, ModConsumables.TOMATO_BEEF_BRISKET_SOUP);
    public static final Item PUFFERFISH_SOUP = new BowlFoodOnlyItem(ModFoods.PUFFERFISH_SOUP, ModConsumables.PUFFERFISH_SOUP);
    public static final Item BORSCHT = new BowlFoodOnlyItem(ModFoods.BORSCHT, ModConsumables.BORSCHT);
    public static final Item BEEF_MEATBALL_SOUP = new BowlFoodOnlyItem(ModFoods.BEEF_MEATBALL_SOUP, ModConsumables.BEEF_MEATBALL_SOUP);
    public static final Item CHICKEN_AND_MUSHROOM_STEW = new BowlFoodOnlyItem(ModFoods.CHICKEN_AND_MUSHROOM_STEW, ModConsumables.CHICKEN_AND_MUSHROOM_STEW);
    public static final Item DONKEY_SOUP = new BowlFoodOnlyItem(ModFoods.DONKEY_SOUP, ModConsumables.DONKEY_SOUP);
    public static final Item BEEF_NOODLE = new BowlFoodOnlyItem(ModFoods.BEEF_NOODLE, ModConsumables.BEEF_NOODLE);
    public static final Item HUI_NOODLE = new BowlFoodOnlyItem(ModFoods.HUI_NOODLE, ModConsumables.HUI_NOODLE);
    public static final Item UDON_NOODLE = new BowlFoodOnlyItem(ModFoods.UDON_NOODLE, ModConsumables.UDON_NOODLE);
    ...
    public static void registerItems() {
        // Block items
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "stove"), STOVE);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "pot"), POT);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "stockpot"), STOCKPOT);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "stockpot_lid"), STOCKPOT_LID);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "oil"), OIL);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "oil_block"), OIL_BLOCK);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "chopping_board"), CHOPPING_BOARD);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "enamel_basin"), ENAMEL_BASIN);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "kitchenware_racks"), KITCHENWARE_RACKS);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "chili_ristra"), CHILI_RISTRA);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "strung_mushrooms"), STRUNG_MUSHROOMS);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "straw_block"), STRAW_BLOCK);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "shawarma_spit"), SHAWARMA_SPIT);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "steamer"), STEAMER);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "millstone"), MILLSTONE);
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "oil_pot"), OIL_POT);

        // Feast
        Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "cold_cut_ham_slices"), COLD_CUT_HAM_SLICES);
