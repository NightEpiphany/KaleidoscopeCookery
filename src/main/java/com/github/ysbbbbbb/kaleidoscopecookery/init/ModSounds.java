...
public class ModSounds {
    ...
    public static final SoundEvent BLOCK_TEAPOT_PROCESSING = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "block.teapot.processing"));
    public static final SoundEvent TRASH_CAN = SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "block.trash_can"));
    ...
    public static void registerSounds() {
        ...
        Registry.register(BuiltInRegistries.SOUND_EVENT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "block.teapot.processing"), BLOCK_TEAPOT_PROCESSING);
        Registry.register(BuiltInRegistries.SOUND_EVENT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "block.trash_can"), TRASH_CAN);
