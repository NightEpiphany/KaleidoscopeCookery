...
public final class ModEffects {
    ...
    public static void registerEffects() {
        ...
        HINDER = Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "hinder"), new BaseEffect(0x9E7E5A));
        PROJECTILE_DODGE = Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "projectile_dodge"), new BaseEffect(0x8E27F7));
        INSTANT_SMELTING = Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "instant_smelting"), new BaseEffect(0xF07C1C));
        VITALITY = Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "vitality"), new BaseEffect(0x6A9E4E));
    }
}
