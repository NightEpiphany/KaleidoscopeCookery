...
public class FlexStockpotRecipeCategory implements IRecipeCategory<FlexStockpotRecipe> {
    ...
    @Override
    public void draw(@NotNull FlexStockpotRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void createRecipeExtras(@NotNull IRecipeExtrasBuilder builder, FlexStockpotRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, FlexStockpotRecipe recipe, @NotNull IFocusGroup focuses) {
        NonNullList<Ingredient> inputs = recipe.getIngredients();
    ...
    @Override
    public @NotNull RecipeType<FlexStockpotRecipe> getRecipeType() {
        return TYPE;
    }
