...
public class FlexPotRecipeCategory implements IRecipeCategory<RecipeHolder<FlexPotRecipe>> {
    public static final IRecipeHolderType<FlexPotRecipe> TYPE = IRecipeType.create(ModRecipes.FLEX_POT_RECIPE);
    ...
    private static final MutableComponent TITLE = Component.translatable("jei.kaleidoscope_cookery.flex_recipe")
            ...
            .append(Component.translatable("block.kaleidoscope_cookery.pot"));
    ...
    @Override
    public void draw(RecipeHolder<FlexPotRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void setRecipe(@NonNull IRecipeLayoutBuilder builder, RecipeHolder<FlexPotRecipe> recipe, @NonNull IFocusGroup focuses) {
        NonNullList<Ingredient> inputs = recipe.value().getIngredients();
        ItemStack output = recipe.value().result().create();
    ...
    @Override
    public @NonNull IRecipeType<RecipeHolder<FlexPotRecipe>> getRecipeType() {
        return TYPE;
    }
