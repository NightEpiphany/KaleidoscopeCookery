...
public class FlexPotRecipeCategory implements IRecipeCategory<FlexPotRecipe> {
    ...
    @Override
    public void draw(FlexPotRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void createRecipeExtras(@NotNull IRecipeExtrasBuilder builder, FlexPotRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, FlexPotRecipe recipe, @NotNull IFocusGroup focuses) {
        NonNullList<Ingredient> inputs = recipe.getIngredients();
    ...
    @Override
    public @NotNull RecipeType<FlexPotRecipe> getRecipeType() {
        return TYPE;
    }
