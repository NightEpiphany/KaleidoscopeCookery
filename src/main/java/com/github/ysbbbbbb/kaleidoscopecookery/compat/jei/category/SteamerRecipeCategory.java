...
public class SteamerRecipeCategory implements IRecipeCategory<RecipeHolder<SteamerRecipe>> {
    public static final IRecipeHolderType<SteamerRecipe> TYPE = IRecipeType.create(ModRecipes.STEAMER_RECIPE);
    ...
    public SteamerRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.iconDraw = guiHelper.createDrawableItemLike(ModItems.STEAMER);
    }

    @Override
    public void draw(@NonNull RecipeHolder<SteamerRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
        this.bgDraw.draw(guiGraphics);
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<SteamerRecipe> holder, @NonNull IFocusGroup focuses) {
    ...
    @Override
    public @NonNull IRecipeHolderType<SteamerRecipe> getRecipeType() {
        return TYPE;
    }
