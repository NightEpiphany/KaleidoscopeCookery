...
public class ModJeiPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(ModItems.POT, FlexPotRecipeCategory.TYPE);
        ...
        registration.addRecipeCatalyst(ModItems.STOCKPOT, FlexStockpotRecipeCategory.TYPE);
