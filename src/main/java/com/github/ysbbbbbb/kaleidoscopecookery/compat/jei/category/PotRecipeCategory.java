...
public class PotRecipeCategory implements IRecipeCategory<RecipeHolder<PotRecipe>> {
    ...
    @Override
    public void draw(RecipeHolder<PotRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
