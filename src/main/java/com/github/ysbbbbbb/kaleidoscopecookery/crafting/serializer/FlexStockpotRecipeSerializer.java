...
public class FlexStockpotRecipeSerializer implements RecipeSerializer<FlexStockpotRecipe> {
    @Override
    public @NotNull FlexStockpotRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
    ...
    @Override
    public @NotNull FlexStockpotRecipe fromNetwork(@NotNull ResourceLocation recipeId, FriendlyByteBuf buf) {
