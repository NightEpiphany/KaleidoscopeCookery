...
public class FlexPotRecipeSerializer implements RecipeSerializer<FlexPotRecipe> {
    @Override
    public @NotNull FlexPotRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
    ...
    @Override
    public @NotNull FlexPotRecipe fromNetwork(@NotNull ResourceLocation recipeId, FriendlyByteBuf buf) {
