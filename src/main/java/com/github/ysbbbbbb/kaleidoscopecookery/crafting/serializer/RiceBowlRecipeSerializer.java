...
public class RiceBowlRecipeSerializer implements RecipeSerializer<RiceBowlRecipe> {
    @Override
    public @NotNull RiceBowlRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
    ...
    @Override
    public @NotNull RiceBowlRecipe fromNetwork(@NotNull ResourceLocation recipeId, FriendlyByteBuf buf) {
