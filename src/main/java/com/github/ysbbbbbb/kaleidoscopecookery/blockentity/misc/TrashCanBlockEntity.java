...
public class TrashCanBlockEntity extends BaseBlockEntity {
    ...
    public void putItem(ItemStack stack) {
        ItemStack result = ItemUtils.insertItemStacked(storage, stack.copy(), false);
    ...
    protected void saveAdditional(@NonNull ValueOutput valueOutput) {
        ...
        ValueOutput.TypedOutputList<ItemStackWithSlot> typedOutputList = valueOutput.list(STORAGE, ItemStackWithSlot.CODEC);
    ...
    protected void loadAdditional(@NonNull ValueInput valueInput) {
        ...
        for (ItemStackWithSlot itemStackWithSlot : valueInput.listOrEmpty(STORAGE, ItemStackWithSlot.CODEC)) {
            if (itemStackWithSlot.isValidInContainer(this.storage.getSlots())) {
                this.storage.setStackInSlot(itemStackWithSlot.slot(), itemStackWithSlot.stack());
            } else this.storage.setStackInSlot(itemStackWithSlot.slot(), ItemStack.EMPTY);
        }
