...
public final class GeneralConfig {
    static ModConfigSpec initConfig() {
     ...
     */
    static ModConfigSpec.BooleanValue SATIATED_SHIELD_ABSORB_ENABLED;
    static ModConfigSpec.BooleanValue SATIATED_SHIELD_ABSORB_EXCESS_DAMAGE;
    static ModConfigSpec.BooleanValue STOVE_FIRING_ENABLED;
    ...
    static ModConfigSpec.BooleanValue IS_SATIATED_SHIELD_DISABLE_WHEN_HUNGRY_EFFECT;
    // 触发饱腹代偿效果所需的最小食物等级，越高说明饱腹代偿的触发条件越苛刻。
    static ModConfigSpec.IntValue SATIATED_SHIELD_MIN_FOOD_LEVEL;
    // 饱腹代偿每吸收一点伤害所需的基础 Exhaustion 数值。
    static ModConfigSpec.DoubleValue SATIATED_SHIELD_ADDITIONAL_EXHAUSTION_PER_DAMAGE;
    // 饱腹代偿效果的伤害减免百分比，不满 1 则必定会受到一部分伤害，越高说明饱腹代偿的抗伤能力越强。
    static ModConfigSpec.DoubleValue SATIATED_SHIELD_DAMAGE_REDUCTION_PERCENT;
    // 饱腹代偿效果的最大伤害减免量，影响面对伤害较高时的抗伤表现，越高说明饱腹代偿的抗伤能力越强。
    static ModConfigSpec.DoubleValue SATIATED_SHIELD_MAX_DAMAGE_REDUCTION;
    /**
     * 饱腹代偿效果下可造成的最小伤害；
     ...
     */
    static ModConfigSpec.DoubleValue SATIATED_SHIELD_MIN_DAMAGE;
    // 当玩家受到饱腹代偿弱点伤害时，每点伤害增加的疲劳值的乘算倍率。
    static ModConfigSpec.DoubleValue SATIATED_SHIELD_WEAKNESS_DAMAGE_MULTIPLIER;
    // 自动烹饪功能是否启用。
    static ModConfigSpec.BooleanValue CREATE_AUTOMATION_ENABLED;
