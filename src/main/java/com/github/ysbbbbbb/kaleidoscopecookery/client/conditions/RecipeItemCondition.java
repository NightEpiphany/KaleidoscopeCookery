...
public class RecipeItemCondition implements ConditionalItemModelProperty {
    public static final MapCodec<RecipeItemCondition> MAP_CODEC = MapCodec.unit(new RecipeItemCondition());
    ...
    public boolean get(@NonNull ItemStack itemStack, @Nullable ClientLevel clientLevel, @Nullable LivingEntity livingEntity, int i, @NonNull ItemDisplayContext itemDisplayContext) {
        return itemStack.get(ModDataComponents.RECIPE_RECORD) != null;
    }
}
