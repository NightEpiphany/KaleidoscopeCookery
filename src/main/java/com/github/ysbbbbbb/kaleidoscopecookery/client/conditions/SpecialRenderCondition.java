...
public class SpecialRenderCondition implements ConditionalItemModelProperty {

    public static final MapCodec<SpecialRenderCondition> MAP_CODEC = MapCodec.unit(new SpecialRenderCondition());
    @Override
    ...
    public boolean get(@NonNull ItemStack itemStack, @Nullable ClientLevel clientLevel, @Nullable LivingEntity livingEntity, int i, @NonNull ItemDisplayContext itemDisplayContext) {
        return itemStack.has(ModDataComponents.SPECIAL_RENDER);
    }
}
