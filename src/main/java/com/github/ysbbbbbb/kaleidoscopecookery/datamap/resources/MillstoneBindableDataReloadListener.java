...
public class MillstoneBindableDataReloadListener implements ResourceManagerReloadListener, IdentifiableResourceReloadListener {
    ...
    private static final ResourceLocation FILE_PATH = ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "datamap/millstone_bindable_data.json");
    ...
    public ResourceLocation getFabricId() {
        return ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "millstone_bindable_data");
    }
}
